...
function Navbar() {
    return (
        <header className="flex justify-between items-center py-8 px-6 md:px-12 text-[#EEF2D8] relative">

            <a href="">
                <h1 className="text-2xl font-[Lora]">A&Z Perfumery</h1>
            </a>
            <nav className="hidden md:flex gap-10 text-xl font-[Lora]">
            ...
            <div className="absolute top-full left-0 w-full bg-[#1f1e1e] text-white p-6 flex-col gap-6 md:hidden hidden">
